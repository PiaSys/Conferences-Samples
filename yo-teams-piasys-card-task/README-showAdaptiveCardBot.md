# Show Adaptive Card Bot - `showAdaptiveCardBot`
...
3. Give the bot a handle (ex: `showAdaptiveCardBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://piasys-teams-card-task.ngrok.io/api/messages`
