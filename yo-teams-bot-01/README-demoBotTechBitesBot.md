# Demo Bot Tech Bites - `demoBotTechBitesBot`
...
3. Give the bot a handle (ex: `demoBotTechBitesBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://yoteamsbot01.azurewebsites.net/api/messages`
