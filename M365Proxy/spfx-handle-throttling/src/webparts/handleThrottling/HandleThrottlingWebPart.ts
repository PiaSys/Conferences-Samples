...
import * as strings from 'HandleThrottlingWebPartStrings';
import HandleThrottling from './components/HandleThrottling';
import { IHandleThrottlingProps } from './components/IHandleThrottlingProps';
...
export default class HandleThrottlingWebPart extends BaseClientSideWebPart<IHandleThrottlingWebPartProps> {
