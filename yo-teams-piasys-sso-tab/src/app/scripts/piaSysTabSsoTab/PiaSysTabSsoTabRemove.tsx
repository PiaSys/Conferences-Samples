...
export interface IPiaSysTabSsoTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IPiaSysTabSsoTabRemoveProps {

}

/**
 * Implementation of PiaSysTabSSO remove page
 */
export class PiaSysTabSsoTabRemove  extends TeamsBaseComponent<IPiaSysTabSsoTabRemoveProps, IPiaSysTabSsoTabRemoveState> {
